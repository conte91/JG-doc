...
different poses. It is also important to use the same model of camera introduced in sec.
...
last stage of rendering (after rasterisation has been done), as depicted in sec.
