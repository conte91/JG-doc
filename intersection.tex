...
% TODO as described in blablabla
...
\begin{figure}[htbp] \label{fig:approximate_shapes}
  \centering
  \begin{tabular}{c|c|c}
  ...
  (right) for different values of $l$, depicted in red, green, and blue.}
\end{figure}
...
\subsection{Computation skipping via surface intersections}
