...
%%% BULLSHIT Thus, the current preference score is compared with the maximum
%%% BULLSHIT of the preference scores (as grasps are better if their preference
%%% BULLSHIT score is lower): if the current score is still higher, 
