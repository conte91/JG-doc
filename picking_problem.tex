...
thesis, together with its documentation, which comes as an integrative part to this more theoretical report, can be found at \href{https://github.com/Conte91/JG}{github.com/Conte91/JG}.

\subsection{Amazon Picking Challenge problem statement} \label{sec:apc-problem}
